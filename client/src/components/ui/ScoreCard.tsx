...
export default function ScoreCard({
  ...
  const containerClass =
    size === "lg"
      ? "bg-[#141416] border border-[#23232a] rounded-2xl p-8 flex flex-col items-center justify-center gap-5"
      : "bg-[#141416] border border-[#23232a] rounded-xl p-5 flex items-center gap-4";
  ...
  const subtitleClass =
    size === "lg" ? "text-sm text-[#6b7280]" : "text-xs text-[#6b7280]";
    ...
    <div className={containerClass}>
      <div className={ringWrapperClass}>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center leading-none">
          ...
          {size === "lg" && (
            <span className="text-sm text-[#4f545e] font-medium font-mono mt-1">
              /100
            </span>
          )}
        </div>
